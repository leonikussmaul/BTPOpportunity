        ...
        onInit: function () {
            ...
            oModel.setData({
                ...
                people: [{
                    ...
                    appointments: [
                        {
                            start: UI5Date.getInstance("2023", "0", "8", "08", "30"),
                            end: UI5Date.getInstance("2023", "0", "8", "09", "30"),
                            title: "Meet Max Mustermann",
                            type: "Type02",
                            tentative: false
                        },
                        {
                            start: UI5Date.getInstance("2023", "0", "11", "10", "0"),
                            end: UI5Date.getInstance("2023", "0", "11", "12", "0"),
                            title: "Team meeting",
                            info: "room 1",
                            type: "Type01",
                        ...
                        {
                            start: UI5Date.getInstance("2023", "0", "12", "11", "30"),
                            end: UI5Date.getInstance("2023", "0", "12", "13", "30"),
                            title: "Lunch",
                            info: "canteen",
                            type: "Type03",
                            tentative: true
                        ...
                        {
                            start: UI5Date.getInstance("2023", "0", "16", "04", "00"),
                            end: UI5Date.getInstance("2023", "0", "16", "22", "30"),
                    ...
                    headers: [
                        {
                            start: UI5Date.getInstance("2023", "0", "15", "8", "0"),
                            end: UI5Date.getInstance("2023", "0", "15", "10", "0"),
                            title: "Reminder",
                            type: "Type06"
                        },
                        {
                            start: UI5Date.getInstance("2023", "0", "15", "17", "0"),
                            end: UI5Date.getInstance("2023", "0", "15", "19", "0"),
                            title: "Reminder",
                            type: "Type06"
                        },
                        {
                            start: UI5Date.getInstance("2023", "8", "1", "0", "0"),
                            end: UI5Date.getInstance("2023", "10", "30", "23", "59"),
                            title: "New quarter",
                            type: "Type10",
                            tentative: false
                        },
                ...
                },
                    {
                        ...
                        appointments: [
                            {
                                start: UI5Date.getInstance("2023", "0", "10", "18", "00"),
                                end: UI5Date.getInstance("2023", "0", "10", "19", "10"),
                                title: "Discussion of the plan",
                                info: "Online meeting",
                                type: "Type04",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "9", "10", "0"),
                                end: UI5Date.getInstance("2023", "0", "13", "12", "0"),
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "15", "08", "00"),
                                end: UI5Date.getInstance("2023", "0", "15", "09", "30"),
                                title: "Discussion of the plan",
                                info: "Online meeting",
                                type: "Type04",
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "15", "18", "00"),
                                end: UI5Date.getInstance("2023", "0", "15", "19", "10"),
                                title: "Discussion of the plan",
                                info: "Online meeting",
                                type: "Type04",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "16", "10", "0"),
                                end: UI5Date.getInstance("2023", "0", "31", "12", "0"),
                                title: "Workshop out of the country",
                                type: "Type07",
                                pic: "sap-icon://sap-ui5",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "01", "11", "10", "0"),
                                end: UI5Date.getInstance("2023", "02", "20", "12", "0"),
                            ...
                            {
                                start: UI5Date.getInstance("2023", "3", "01", "10", "0"),
                                end: UI5Date.getInstance("2023", "3", "31", "12", "0"),
                                title: "Workshop out of the country",
                                type: "Type07",
                                pic: "sap-icon://sap-ui5",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "4", "01", "10", "0"),
                                end: UI5Date.getInstance("2023", "4", "31", "12", "0"),
                                title: "Out of the office",
                                type: "Type08",
                                tentative: false
                            },
                            {
                                start: UI5Date.getInstance("2023", "7", "1", "0", "0"),
                                end: UI5Date.getInstance("2023", "7", "31", "23", "59"),
                                title: "Vacation",
                                info: "out of office",
                                type: "Type04",
                                tentative: false
                        ...
                        headers: [
                            {
                                start: UI5Date.getInstance("2023", "0", "15", "9", "0"),
                                end: UI5Date.getInstance("2023", "0", "15", "10", "0"),
                                title: "Payment reminder",
                                type: "Type06"
                            },
                            {
                                start: UI5Date.getInstance("2023", "0", "15", "16", "30"),
                                end: UI5Date.getInstance("2023", "0", "15", "18", "00"),
                    ...
                    },
                    {
                        ...
                        appointments: [
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "15", "13", "00"),
                                end: UI5Date.getInstance("2023", "0", "15", "16", "00"),
                                title: "Discussion with clients",
                                info: "online",
                                type: "Type02",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "16", "0", "0"),
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "17", "1", "0"),
                                end: UI5Date.getInstance("2023", "0", "18", "22", "0"),
                                title: "Workshop",
                                info: "regular",
                                type: "Type07",
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "19", "08", "30"),
                                end: UI5Date.getInstance("2023", "0", "19", "18", "30"),
                                title: "Meet John Doe",
                                type: "Type02",
                                tentative: false
                            },
                            {
                                start: UI5Date.getInstance("2023", "0", "19", "10", "0"),
                                end: UI5Date.getInstance("2023", "0", "19", "16", "0"),
                                title: "Team meeting",
                                info: "room 1",
                                type: "Type01",
                                pic: "sap-icon://sap-ui5",
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "19", "07", "00"),
                                end: UI5Date.getInstance("2023", "0", "19", "17", "30"),
                                title: "Discussion with clients",
                                type: "Type02",
                                tentative: false
                            },
                            {
                                start: UI5Date.getInstance("2023", "0", "20", "0", "0"),
                                end: UI5Date.getInstance("2023", "0", "20", "23", "59"),
                                title: "Vacation",
                                info: "out of office",
                                type: "Type04",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "0", "22", "07", "00"),
                                end: UI5Date.getInstance("2023", "0", "27", "17", "30"),
                                title: "Discussion with clients",
                                info: "out of office",
                                type: "Type02",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "2", "13", "9", "0"),
                                end: UI5Date.getInstance("2023", "2", "17", "10", "0"),
                                title: "Payment week",
                                type: "Type06"
                            },
                            {
                                start: UI5Date.getInstance("2023", "03", "10", "0", "0"),
                                end: UI5Date.getInstance("2023", "05", "16", "23", "59"),
                                title: "Vacation",
                                info: "out of office",
                                type: "Type04",
                                tentative: false
                            ...
                            {
                                start: UI5Date.getInstance("2023", "07", "1", "0", "0"),
                                end: UI5Date.getInstance("2023", "09", "31", "23", "59"),
                                title: "New quarter",
                                type: "Type10",
                                tentative: false
                            }
